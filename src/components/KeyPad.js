  ...
  return (
    <div className="buttons">
        ...
        <div className="two">
          ...
          <button data-testid="divide" id="operator-divide" onClick={() => operatorClick('/')}>/</button>
          ...
          <button data-testid="multi" id="operator-multiply" onClick={() => operatorClick('*')}>x</button>
          ...
          <button data-testid="subtract" id="operator-subtract" onClick={() => operatorClick('-')}>-</button>
          <button id="decimal" onClick={() => decimalClick()}>.</button>
          <button data-testid="number0" id="number0" onClick={() => numberClick('0')}>0</button>
          <button data-testid="equals" id="operator-equals" onClick={() => operatorClick('=')}>=</button>
